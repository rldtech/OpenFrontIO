...
export class HelpModal extends LitElement {
  ...
  render() {
    return html`
      <o-modal id="helpModal" title="Help / Instructions">
        ...
        <div class="flex flex-col md:flex-row gap-4">
          <img src="/images/helpModal/radialMenu.png" alt="Radial menu" title="Radial menu" class="radial-menu-image" style=" width: 211px;
      height: 200px;" />
          <div>
            ...
            <ul>
              ...
              <li class="mb-4">
                <img src="/images/InfoIcon.svg" class="inline-block icon" style="fill: white; background: transparent; width:32px;"/> - Open the Info menu.</li>
