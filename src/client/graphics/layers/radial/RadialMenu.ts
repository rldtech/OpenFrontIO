...
import { AllPlayers, Cell, Game, Player, UnitType, UnitTypes } from "../../../../core/game/Game";
...
export class RadialMenu implements Layer {
    ...
    private onContextMenu(event: ContextMenuEvent) {
        ...
        if (myPlayer.units(UnitTypes.TransportShip).length >= this.game.config().boatMaxNumber()) {
            return
        }
