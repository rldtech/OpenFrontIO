...
import {  Execution, MutableGame, MutablePlayer, MutableUnit, Player, PlayerID, Tile, Unit, UnitType, UnitTypes } from "../game/Game";
...
export class TradeShipExecution implements Execution {
    ...
    tick(ticks: number): void {
        if (this.tradeShip == null) {
            this.tradeShip = this.player.addUnit(UnitTypes.TradeShip, 0, this.srcPort.tile())
        }
